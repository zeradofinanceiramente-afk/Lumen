                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 gap-2">
                                    ...
                                    <button onClick={() => setFontProfile('code')} className={`p-3 text-left border text-xs font-bold transition-all font-code ${fontProfile === 'code' ? 'bg-white/10 border-white text-white' : 'bg-black border-slate-800 text-slate-500'}`}>[ Código_Fira ]</button>
                                    <button onClick={() => setFontProfile('cute')} className={`p-3 text-left border text-xs font-bold transition-all font-cute ${fontProfile === 'cute' ? 'bg-white/10 border-white text-white' : 'bg-black border-slate-800 text-slate-500'}`}>[ Fofura_Fredoka ]</button>
                                </div>
                            </div>
                        </div>
